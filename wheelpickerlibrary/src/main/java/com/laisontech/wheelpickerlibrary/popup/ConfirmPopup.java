package com.laisontech.wheelpickerlibrary.popup;
...
import com.laisontech.wheelpickerlibrary.util.ConvertUtils;
...
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    public ConfirmPopup(Activity activity) {
        ...
        submitText = activity.getString(R.string.Confirm);
    }
