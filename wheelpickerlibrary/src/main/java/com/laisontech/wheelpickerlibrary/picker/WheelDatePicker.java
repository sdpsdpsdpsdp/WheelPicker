...
import com.laisontech.wheelpickerlibrary.R;
import com.laisontech.wheelpickerlibrary.util.DateUtils;
import com.laisontech.wheelpickerlibrary.widget.WheelView;
...
public class WheelDatePicker extends WheelPicker {
     ...
     */
    public WheelDatePicker(Activity activity) {
     ...
     */
    public WheelDatePicker(Activity activity, @Mode int mode) {
        super(activity);

        yearLabel = activity.getResources().getString(R.string.Year);
        monthLabel = activity.getResources().getString(R.string.Month);
        dayLabel = activity.getResources().getString(R.string.Day);
